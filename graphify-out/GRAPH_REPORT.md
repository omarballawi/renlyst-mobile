...
## Corpus Check
- 170 files · ~90,918 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1171 nodes · 3344 edges · 58 communities (56 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `331f46c9`
...
Cohesion: 0.05
Nodes (67): newProfile(), packetText(), sources, styles, TrustedImportScreen(), applyConfirmedIdentity(), ConfirmedDrugIdentity, tradeNamesFromInput() (+59 more)
...
Cohesion: 0.10
Nodes (23): BackupHistory, BackupScreen(), emptyHistory, styles, ToggleField(), Section(), icons, TabLayout() (+15 more)

### Community 6 - "notes.tsx"
Cohesion: 0.06
Nodes (57): bands, chapters, ChoiceField(), DrugEditorScreen(), editorSchema, EditorSection, editorSections, EditorValues (+49 more)

### Community 7 - "radii"
Cohesion: 0.13
Nodes (34): NewEncounterScreen(), ImportCompleteScreen(), CompareDrugsScreen(), ShelfQuestScreen(), MistakeVaultScreen(), PracticeSessionScreen(), SystemPracticeScreen(), QuickSearchScreen() (+26 more)
...
Cohesion: 0.25
Nodes (13): EditBrandScreen(), Field(), styles, DrugPhotosScreen(), styles, CaptureImageAsset, ImageEditorModal(), drugQueryKeys (+5 more)

### Community 10 - "index.tsx"
Cohesion: 0.14
Nodes (24): NoteField(), styles, ReportEditorScreen(), Breakdown(), MasteryRadar(), polygonPoints(), radarLabels, radarPoint() (+16 more)

### Community 11 - "useTheme"
Cohesion: 0.11
Nodes (27): ClinicalRichText(), ClinicalTone, DrugProfileScreen(), masteryItems, ProfileTopic, ProfileTopicBar(), profileTopics, SectionProps (+19 more)

### Community 12 - "index.ts"
Cohesion: 0.28
Nodes (5): PracticeSessionContent(), resolvePracticeMode(), styles, isPracticeMode(), appHaptics

### Community 13 - "backupPersistence.ts"
Cohesion: 0.16
Nodes (21): CaptureScreen(), AddBrandScreen(), ProductEditor(), brandDraftFor(), BrandMutationError, BrandMutationErrorCode, BrandProductDraft, BrandProductEditDraft (+13 more)
...
Cohesion: 0.07
Nodes (44): AboutScreen(), styles, AddHubScreen(), AddRoute(), styles, styles, CompareRow(), styles (+36 more)
...
Cohesion: 0.24
Nodes (18): canonicalFor(), DuplicateProfileMergeResult, earliest(), earliestNullable(), latest(), mergeDrug(), mergeDuplicateProfiles(), mergeJSONArrays() (+10 more)

### Community 20 - "trainingRepository.ts"
Cohesion: 0.14
Nodes (13): breakdown(), CountRow, EncounterDraft, PayloadRow, ShiftReflection, summarizeTrainingAnalytics(), TrainingAnalytics, TrainingBreakdown (+5 more)
...
Cohesion: 0.08
Nodes (21): initializeDatabase(), errorText(), isRetryableDatabaseError(), retryableDatabaseMarkers, retryBusyDatabaseOperation(), DatabaseVersionError, migrateDatabase(), migrationSQLForPlatform() (+13 more)
...
Cohesion: 0.13
Nodes (24): LearningRepository, LearningSummary, PayloadRow, DailyActivityBackup, LearningProfileBackup, buildWeeklyActivity(), FocusAction, FocusRecommendation (+16 more)

### Community 31 - "reviewScheduler.ts"
Cohesion: 0.13
Nodes (21): SaveDestination, styles, Field(), styles, styles, ProtectedField(), ProviderSettingsEditor(), providerSettingsQueryKey (+13 more)
...
Cohesion: 0.19
Nodes (14): styles, CachedPracticePackScreen(), styles, DailyRefreshScreen(), styles, practiceQueryKeys, useCachedPracticePack(), useDailyRefresh() (+6 more)

### Community 37 - "embeddedImages.ts"
Cohesion: 0.16
Nodes (6): CountRow, ingredientNames(), repairLegacyProductAuthority(), arabicSearchText(), DrugRepository, canonicalKeyForDrug()
...
Cohesion: 0.26
Nodes (12): ReportEditor(), sections, styles, dateFromLegacy(), buildTrainingReport(), groupedCounts(), inPeriod(), masteredByChapter() (+4 more)
...
Cohesion: 0.10
Nodes (19): DrugRelationshipItem, RelationshipRepository, RelationshipRow, backupRecordCountsSchema, dataArray, drugBackupSchema, drugProductBackupSchema, DrugRelationshipBackup (+11 more)
...
- **Why does `DrugBackup` connect `DrugBackup` to `dose.tsx`, `trustedSources.ts`, `providerClients.ts`, `Community 3`, `mergeDuplicateProfiles.ts`, `notes.tsx`, `backupService.ts`, `useLocale`, `useTheme`, `backupPersistence.ts`, `Community 14`, `today.tsx`, `drugRepository.ts`, `practiceRepository.ts`, `session.tsx`, `DrugBackup`, `index.ts`, `learningRepository.ts`, `reviewScheduler.ts`, `generateDeepSeekPracticePack`, `embeddedImages.ts`, `drugBackupSchema`, `reviewScheduler.ts`, `Community 48`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `useTheme()` connect `radii` to `dose.tsx`, `trustedSources.ts`, `Community 3`, `Community 36`, `mergeDuplicateProfiles.ts`, `notes.tsx`, `drugBackupSchema`, `useLocale`, `index.tsx`, `useTheme`, `index.ts`, `backupPersistence.ts`, `ThemeProvider.tsx`, `today.tsx`, `reviewScheduler.ts`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `dateFromLegacy()` connect `drugBackupSchema` to `generateDeepSeekPracticePack`, `Community 36`, `mergeDuplicateProfiles.ts`, `embeddedImages.ts`, `radii`, `notes.tsx`, `backupService.ts`, `index.tsx`, `useTheme`, `reviewScheduler.ts`, `drugRepository.ts`, `practiceRepository.ts`, `session.tsx`, `DrugBackup`, `learningRepository.ts`?**
